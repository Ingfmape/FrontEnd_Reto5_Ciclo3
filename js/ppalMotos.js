 ...
 */
    function traerInformacionMotos() {
        $.ajax({
            url: "http://129.151.122.204:8080/api/Motorbike/all",
            type: "GET",
            datatype: "JSON",
    ...
    function guardarInformacionMotos() {
        ...
        $.ajax({
            ...
            url: "http://129.151.122.204:8080/api/Motorbike/save",
    ...
    function borrarMoto(idElemento) {
        ...
        $.ajax({
            url: "http://129.151.122.204:8080/api/Moto/"+idElemento,
            type: "DELETE",
            data: dataToSend,
...
function traerInformacionClientes() {
    $.ajax({
        url: "http://129.151.122.204:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function guardarInformacionClientes() {
    ...
    $.ajax({
        ...
        url: "http://129.151.122.204:8080/api/Client/save",
        success: function (response) {
            console.log(response);
 ...
 */
    function traerInformacionCategorias() {
        $.ajax({
            url: "http://129.151.122.204:8080/api/Category/all",
            type: "GET",
            datatype: "JSON",
            success: function (respuesta) {
                console.log(respuesta);
    ...
    function guardarInformacionCategorias() {
        ...
        $.ajax({
            ...
            url: "http://129.151.122.204:8080/api/Category/save",
            success: function (response) {
                console.log(response);
                console.log("Registro almacenado correctamente");
                alert("Registro almacenado correctamente");
    ...
    */
    function traerInformacionMensajes() {
        $.ajax({
            url: "http://129.151.122.204:8080/api/Message/all",
            type: "GET",
            datatype: "JSON",
            success: function (respuesta) {
                console.log(respuesta);
    ...
    function guardarInformacionMensajes(){
        if ($("#MSmessagetext").val().length==0 ){
            ...
            let var2 = {
                ...
                dataType: 'JSON',
                data: JSON.stringify(var2),
                url:"http://129.151.122.204:8080/api/Message/save",
                success:function(response) {
                        console.log(response);
    ...
    function actualizarInformacionMensaje(idElemento){
        ...
        let dataToSend=JSON.stringify(myData);
        $.ajax({
            url:"http://129.151.122.204:8080/api/Message/update",
            type:"PUT",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
    ...
    function borrarMensaje(idElemento){
        ...
        $.ajax({
            url:"http://129.151.122.204:8080/api/Message/"+idElemento,
            type:"DELETE",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
    ...
    */
        function traerInformacionReservaciones() {
            $.ajax({
                url: "http://129.151.122.204:8080/api/Reservation/all",
                type: "GET",
                datatype: "JSON",
                success: function (respuesta) {
                    console.log(respuesta);
        ...
        */
        function guardarInformacionReservaciones() {
            if($("#RVstartDate").val().length == 0 || $("#RVdevolutionDate").val().length == 0 || $("#RVstatus").val().length == 0){
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json",
                    url:"http://129.151.122.204:8080/api/Reservation/save",
                    data: dataToSend,
                    datatype: "json",
                    success: function (response) {
                        console.log(response);
            ...
            $.ajax(
                {
                    dataType: 'json',
                    data: dataToSend,
                    url:"http://129.151.122.204:8080/api/Reservation/"+idElemento,
                    type: 'DELETE',
                    contentType: "application/JSON",
                    success: function (response) {
                        console.log(response);
        ...
        function cargarDatosReservation(id) {
            $.ajax({
                dataType: 'json',
                url:"http://129.151.122.204:8080/api/Reservation/"+id,
                type: 'GET',
                success: function (response) {
                    console.log(response);
                    var item = response;
        ...
        function actualizarReservation(idElemento) {
            if($("#RVstartDate").val().length == 0 || $("#RVdevolutionDate").val().length == 0 || $("#RVstatus").val().length == 0){
                ...
                $.ajax({
                    ...
                    data: dataToSend,
                    contentType: "application/JSON",
                    url:"http://129.151.122.204:8080/api/Reservation/update",
                    type: "PUT",
                    success: function (response) {
                        console.log(response);
                        $("#miListaReservation").empty();
    ...
    */
    function traerReporteStatus(){
        console.log("test");
        $.ajax({
            url:"http://129.151.122.204:8080/api/Reservation/report-status",
            type:"GET",
            datatype:"JSON",
            success:function(respuesta){
                console.log(respuesta);
    ...
    function traerReporteDate(){
        ...
        console.log(fechaCierre);
            $.ajax({
                url:"http://129.151.122.204:8080/api/Reservation/report-dates/"+fechaInicio+"/"+fechaCierre,
                type:"GET",
                datatype:"JSON",
                success:function(respuesta){
                    console.log(respuesta);
        ...
        function traerReporteClientes(){
            $.ajax({
                url:"http://129.151.122.204:8080/api/Reservation/report-clients",
                type:"GET",
                datatype:"JSON",
                success:function(respuesta){
                    console.log(respuesta);
